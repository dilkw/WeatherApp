...
public class ChooseAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(ChooseAreaActivity.this,android.R.layout.simple_expandable_list_item_1,dataList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (currentLevel == LEVEL_PROVINCE) {
                    ...
                    String userCity_name = countyList.get(position).getCountyName();

                    User_city user_city = new User_city();
                    user_city.setUersCityName(userCity_name);
                    user_city.setWeatherId(weatherId);
                    user_city.save();

                    WeatherActivity.weatherIdList.add(weatherId);
                    WeatherActivity.user_cityList.add(user_city);
    ...
    public void onBackPressed(){
        Intent intent = new Intent();
        intent.getIntArrayExtra("data_return");
